  ...
  return (
    <Card className="mx-auto" style={{ maxWidth: 400 }}>
      ...
      <Card.Body className="text-center">
        ...
        {/* TODO 4: Thay số 0 bằng {state.count} để hiển thị giá trị động */}
        <h1 data-testid="count-display">{state.count}</h1>

        <ButtonGroup className="mt-3">
          {/* TODO 5: Thêm onClick gọi hành động DECREMENT */}
          <Button 
            variant="danger"  
          ...
          {/* TODO 6: Thêm onClick gọi hành động RESET */}
          <Button 
            variant="secondary" 
          ...
          {/* TODO 7: Thêm onClick gọi hành động INCREMENT */}
          <Button 
            variant="success" 
